/*
  ...
  1. Changes
    ...
    - This is necessary because during registration, users are initially in the anon role
    - The security check still ensures users can only create profiles with their own ID
*/
